...
public class AuthenticationDialog extends Dialog<AuthenticationResult> {
    ...
    private IEmployeeAuthenticationService authenticationService;
    ...
    public AuthenticationDialog(ApplicationContext ctx) {
        this.authenticationService = (IEmployeeAuthenticationService) ctx.getBean("employeeAuth");
        ...
        this.setResultConverter(dialogButton -> {
            if(dialogButton == loginButtonType) {
                try {
                    this.authenticationResult = this.authenticationService.authenticateOperator(username.getText(), passwordField.getText());
