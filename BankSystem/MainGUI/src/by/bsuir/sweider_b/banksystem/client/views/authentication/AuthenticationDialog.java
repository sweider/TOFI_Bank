...
public class AuthenticationDialog extends Dialog<AuthenticationResult> {
    ...
    private ICustomerAuthenticationService authenticationService;
    ...
    public AuthenticationDialog(ApplicationContext ctx) {
        this.authenticationService = (ICustomerAuthenticationService) ctx.getBean("authService");
        ...
        this.setResultConverter(dialogButton -> {
            if(dialogButton == loginButtonType) {
                try {
                    this.authenticationResult = this.authenticationService.authenticateCustomer(username.getText(), passwordField.getText());
